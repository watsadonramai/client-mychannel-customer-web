export const environment = {
  ...
  name: 'pvt',
  baseAPIURL: '/api',
  logoutUrl: 'https://10.137.44.27:9443/TDMWeb/Login.do',
  homeUrl: 'https://10.137.44.27:9443/TDMWeb/Login.do',
  cspUrl: 'http://10.13.81.39:8103/SFFWeb/pages/om/om_customer_portal.jsf?idRefresh=0',
  sffHomeUrl: 'https://10.137.31.32:8103/SFFWeb/pages/home/portal.jsf',
